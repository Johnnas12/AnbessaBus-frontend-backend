@extends('storeKeeper.layouts.index')
                        ...
                        <form class="needs-validation" novalidate action="{{ route('storekeeper.storeBuses') }}"
                            ...
                            <div class="panel-content">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label" for="validationCustom01">Bus Type<span
                                                class="text-danger">*</span> </label>
                                    ...
                                    <div class="col-md-4 text-center">
                                        <button class="btn btn-primary" style="background: #F36D44">Register Bus</button>
                                    </div>
                                </div>
                            </div>
                        </form>
