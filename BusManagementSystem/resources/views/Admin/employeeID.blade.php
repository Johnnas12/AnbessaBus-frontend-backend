...
<div class="container d-flex justify-content-center align-items-center" >
    ...
    <div class="row">
      <div class="col-md-12">
        <button class="btn mb-2" onclick="printIDCard()"  style="background: #F36D44; color:white">Print ID</button>
        <div class="card p-2 shadow-lg rounded " id="idCard" style="background-color: #ee7e5b; max-width: 400px; border-radius:20px;" >
             <div class="row">
                <div class="col-md-3">
...
<script>
    function printIDCard() {
        ...
        var backgroundColor = window.getComputedStyle(idCard).backgroundColor;

        var printContent = '<div style="background-color: ' + backgroundColor + '">';
        printContent += idCardDiv.innerHTML;
        printContent += '</div>';
