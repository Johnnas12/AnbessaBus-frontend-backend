    ...
    <div class="container mt-2">
        <div class="card shadow-lg mt-4">
            <div id="panel-2" class="panel">
                <div class="panel-hdr">
                    <h6 class="pt-3 px-3">
                        Tarrif <span class="fw-300"><i>Editing Form</i></span>
                    </h6>
                    <hr>
                </div>
                <div class="panel-container show m-1 p-4">
                    <div class="panel-content p-0">
                        <form class="needs-validation" novalidate action="{{route('updateRoute', $data->id)}}" enctype="multipart/form-data"  method="POST">
                            @method("PATCH")
                            @csrf
