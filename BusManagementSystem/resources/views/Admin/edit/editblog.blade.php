            ...
            <div class="col-lg-7 mx-auto">
                <div class="card mt-2 mx-auto p-4 bg-light">
                    <div class="card-body bg-light">
                        <div class = "container">
                            <form id="contact-form" role="form" method="POST" action="{{ route('updateblog', $blog->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="form_name" type="text" name="title" value="{{$blog->title}}" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="form_email" type="file" value="{{$blog->profile}}" name="profile" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="form_message" name="description" class="form-control"
                                                    ...
                                                    required="required" data-error="Please, leave us a message.">{{$blog->description}}</textarea>
                                            </div>
