...
Future<void> logout(BuildContext context) async {
    final box = GetStorage();
    String token = box.read('token'); // Assuming you store the token in GetStorage

    // Make a logout API request to Laravel backend
    var response = await http.post(
      Uri.parse('http://192.168.153.1:81/api/logout'),
      headers: {
